...
export default {
  data() {
    return {
      ...
      addOrUpdateChapterTitle: "",
      addOrUpdateVideoTitle: "",
  ...
  methods: {
    ...
    openVideo(chapterId) {
      ...
      this.addOrUpdateVideoTitle = "添加小节";
      //弹框
    ...
    // 编辑-数据回显
    editVideo(videoId) {
      this.addOrUpdateVideoTitle = "编辑小节";
      this.dialogVideoFormVisible = true;
    ...
    openEditChatper(chapterId) {
      this.addOrUpdateChapterTitle = "修改章节";
      //弹框
    ...
    //弹出添加章节页面
    openChapterDialog() {
      this.addOrUpdateChapterTitle = "添加章节";
      //弹框
      this.dialogChapterFormVisible = true;
      //表单数据清空
      this.chapter.title = "";
